...
class Weibo:
    # cookie = {"Cookie": "dde7a7f5c0ea95ade5fba4db48f69db6"}
    # cookie = {"Cookie": ""}  # 将your cookie替换成自己的cookie
    cookie = {"Cookie": "_T_WM=13644396998; WEIBOCN_FROM=1110006030; SUB=_2A25x-9PvDeRhGeNG71sU8irKyDyIHXVTB_2nrDV6PUJbkdAKLUXZkW1NS1muohSZDhlHb8g86UYR12p6YOiOK2uE; SUHB=02M_LHkwLMmGa8; SCF=AkxDrVF_prMhcADZc3pyzSH7pCMWZ235ALVddwF8Rn01_V8phAb32MKOQkXIi4LHcEkTfh-T-ZwdC5CeDE4hzTE.; SSOLoginState=1560257471; MLOGIN=1; M_WEIBOCN_PARAMS=lfid%3D102803%26luicode%3D20000174%26uicode%3D20000174"}

    def __init__(self, user_id, filter=0):
        """Weibo类初始化"""
        self.user_id = 2321615032  # 用户id，即需要我们输入的数字，如昵称为“Dear-迪丽热巴”的id为1669879400
        self.filter = 0  # 取值范围为0、1，程序默认值为0，代表要爬取用户的全部微博，1代表只爬取用户的原创微博
        self.nickname = "青春湖北"  # 用户昵称，如“Dear-迪丽热巴”
